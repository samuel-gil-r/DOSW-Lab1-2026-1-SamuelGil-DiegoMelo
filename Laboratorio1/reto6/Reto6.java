...
public class Reto6 {
    ...
    static {
        comandos.put("SALUDAR", () ->
                System.out.println("La máquina dice: ¡Saludos, viajero!")
        );

        comandos.put("DESPEDIR", () ->
                System.out.println("La máquina dice: Que los bits te acompañen.")
        );
        ...
        comandos.put("DANZAR", () ->
                System.out.println("La máquina gira: Girando en modo fiesta.")
        );
        ...
        comandos.put("SUSURRAR", () ->
                System.out.println("La máquina susurra: Shhh... los bugs duermen.")
        );

        comandos.put("ANALIZAR", () ->
                System.out.println("La máquina procesa: ¡Eres increíble programando!")
        );
    }
